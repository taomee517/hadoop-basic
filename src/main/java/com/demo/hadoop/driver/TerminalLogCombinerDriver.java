...
import com.demo.hadoop.reducer.TerminalLogCountCombiner;
...
public class TerminalLogCombinerDriver {
    public static void main(String[] args) throws Exception {
        ...
        //设置驱动类
        job.setJarByClass(TerminalLogCombinerDriver.class);
        ...
        //设置局部聚合combiner
        job.setCombinerClass(TerminalLogCountCombiner.class);

        //指定数据源和数据处理后的结果路径
        FileInputFormat.setInputPaths(job, new Path("E:\\private\\test\\logs\\terminal.log"));
        String outDir = "E:\\private\\test\\logs\\combiner";
